...
public class SensorFCServlet extends HttpServlet {
    ...
    //cette fois-ci on utilise le DAO qui fonctionne avec JPA. Comme 2 EJB implémentent l'interface SensorDAO, on précise lequel on veut utiliser.
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(request.getParameter("action")) {
            case "update" :
                        ...
                        //JPA interdit de modifier un attribut mappé à une clé primaire
                        s2.setId(s.getId());
            ...
            case "findbyid" :
                        ...
                        sensorList.add(sensorDAO.findById(Integer.valueOf(request.getParameter("id"))));
