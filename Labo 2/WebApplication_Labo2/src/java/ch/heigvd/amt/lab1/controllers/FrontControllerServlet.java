...
public class FrontControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //cette fois-ci on met la liste de mesures dans la session HTTP pour faire les tests de charge de mémoire
        request.getSession().setAttribute("measureList", measureList);
        request.getSession().setAttribute("poids", new byte[10 * 1024 * 1024]);
